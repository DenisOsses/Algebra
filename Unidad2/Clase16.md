...
:class: note
Para generar el video, ejecute: `manim -pql slides/Clase16.py Clase16` y mueva el archivo resultante a `_static/videos/Clase16.mp4`.
:::

<div class="video-container" style="text-align: center; margin-bottom: 2em;">
  <video width="80%" controls>
    <source src="../_static/videos/Clase16.mp4" type="video/mp4">
...
- Utilizar los teoremas del seno y el coseno en la resolución de problemas.
...
:::
    ...
    \visible<2-4>{```{image} ../Clases/TeoSen.png
:align: center
:width: 70%
```}
...
::: 
    ...
    \visible<4>{```{image} ../Clases/LeyCoseno.png
:align: center
:width: 70%
```}
