...
Consideremos $$f:\left[-\frac{\pi}{2},\frac{\pi}{2}\right]\mapsto[-1,1]~~,~~f(x)=\sen(x).$$ En este intervalo $\sen(x)$ es biyectiva y tiene inversa. Su inversa se denomina **arcoseno** de $x$.  Anotamos $$f^{-1}:[-1,1]\mapsto\left[-\frac{\pi}{2},\frac{\pi}{2}\right]~~,~~f^{-1}(x)=\arcsen(x).$$
```
...
Consideremos $$f:[0,\pi]\mapsto[-1,1]~~,~~f(x)=\cos(x).$$ En este intervalo $\cos(x)$ es biyectiva y tiene inversa. Su inversa se denomina **arcocoseno** de $x$.  Anotamos $$f^{-1}:[-1,1]\mapsto[0,\pi]~~,~~f^{-1}(x)=\arccos(x).$$
```
...
Consideremos $$f:\left]-\frac{\pi}{2},\frac{\pi}{2}\right[\mapsto\mathbb{R}~~,~~f(x)=\tan(x).$$ En este intervalo $\tan(x)$ es biyectiva y tiene inversa. Su inversa se denomina **arcotangente** de $x$.  Anotamos $$f^{-1}:\mathbb{R}\mapsto\left]-\frac{\pi}{2},\frac{\pi}{2}\right[~~,~~f^{-1}(x)=\arctan(x).$$
```
...
Una **ecuación trigonométrica** es una expresión de la forma $f(x)=0$ donde $f$ es una combinación de funciones trinométricas, para las cuales debemos encontrar los ángulos $x\in\mathbb{R}$ que satisfagan esta ecuación. Lo esencial para resolverlas es recordar la periodicidad de ellas.
```
