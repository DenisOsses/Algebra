...
:class: tip
 ...
 Sea $A$ un conjunto dado. Una **sucesión** es una función  de la forma $f: D \subseteq \mathbb{N} \to A$.  Así, para cada $n \in D$, $f(n)$ es un elemento de A.  Usualmente escribimos $f(n):=f_n$ o $f(n):=a_n$ para referirnos al término general de la sucesión y $\{f_n\}_{n\in D}$ para la sucesión.
``` 
...
Sean $d\in\mathbb{R}$ y $a\in\mathbb{R}$. Una **progresión aritmética** (P.A.) de primer término $a$ y diferencia $d$ es una sucesión $\{a_n\}_{n\in\mathbb{N}}$ tal que \begin{eqnarray*}a_1&=&a\\ a_{n+1}&=&a_n+d~,~n\in\mathbb{N} \end{eqnarray*} Lo que caracteriza a una P.A. es que la diferencia de dos términos consecutivos de la sucesión es siempre constante igual a $d$.
```
...
Sean $r\in\mathbb{R}-\{0\}$ y $a\in\mathbb{R}$. Una **progresión geométrica** (P.G.) de primer término $a$ y razón $r$ es una sucesión $\{a_n\}_{n\in\mathbb{N}}$ tal que \begin{eqnarray*}a_1&=&a\\ a_{n+1}&=&a_n\cdot r~,~n\in\mathbb{N} \end{eqnarray*}  Lo que caracteriza a una P.G. es que la razón de dos términos consecutivos de la sucesión es siempre constante igual a $r$.
```
